...
import slimeknights.tconstruct.plugin.rei.casting.AbstractCastingCategory;
...
public final class ArrowWidget extends Arrow {
  ...
  public ArrowWidget(Point point, int u, int v) {
  ...
  public void renderBackground(PoseStack matrices, boolean dark, float alpha) {
    ...
    RenderSystem.setShaderTexture(0, AbstractCastingCategory.BACKGROUND_LOC);
