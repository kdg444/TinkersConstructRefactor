...
public class CastingDisplay implements Display {
  ...
  public CastingDisplay(CategoryIdentifier<CastingDisplay> id, IDisplayableCastingRecipe recipe) {
    this.id = id;
    this.recipe = recipe;
    this.input = List.of(EntryIngredients.of(VanillaEntryTypes.FLUID, BasicCategory.toREIFluids(recipe.getFluids())), EntryIngredients.ofItemStacks(recipe.getCastItems()));
