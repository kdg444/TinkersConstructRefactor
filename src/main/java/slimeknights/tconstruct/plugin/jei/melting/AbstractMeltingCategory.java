...
import slimeknights.tconstruct.plugin.jei.AbstractTinkersCategory;
...
public abstract class AbstractMeltingCategory extends AbstractTinkersCategory<MeltingRecipe> {
...
//    });
  ...
  public void draw(MeltingRecipe recipe, PoseStack matrices, double mouseX, double mouseY) {
    // draw the arrow
//    cachedArrows.getUnchecked(recipe.getTime() * 5).draw(matrices, 56, 18); TODO: PORT
